...
<body style=" background-color: #f2f2f2; ">
    ...
    <header id="nav">
        <section class="navsec">
            ...
            <nav>
                <a href="#"> Beranda
                    <div class="dropdown">
                        <button class="dropbtn"><a href="#topic">Kelola Data</a></button>
                        <div class="dropdown-content"><a href="Akun.php">Mengelola Akun</a>
                            <a href="Nilai.php">Nilai User</a>
                        </div>
                    </div>
                </a>
    ...
    <center>
        <div class="card" style="text-align: center; color: #ffffff; background-color: #ab4840; border-radius: 30px;  width:38%;">
            <h1> SELAMAT DATANG ADMIN </h1>
        </div>
        </br> <svg xmlns="https://www.w3.org/2000/svg" width="21%" height="8%" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
    ...
    <div id="topic" style="background-color: #f2f2f2;">
        ...
        <div style="text-align: center; padding: 18px;">
            <a href="Akun.php" target="_blank" style="margin-right: 40px;">
                <img class="card" style="background-color: #ffffff; margin: 1%; padding: 1%; width: 13%; height: 160px; border-radius: 90px; border: 5px solid #000;" src="../images/Tampilan/Status.png" alt="maths">
            </a>

            <a href="Nilai.php" target="_blank" style="margin-right: 40px;">
                <img class="card" style="background-color: #ffffff; margin: 1%; padding: 1%; width: 13%; height: 160px; border-radius: 90px; border: 5px solid #000;" src="../images/Tampilan/Nilai.png" alt="maths">
            </a>
        </div>
    </div>
    </br></br>
