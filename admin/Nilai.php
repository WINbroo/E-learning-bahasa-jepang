...
<body style=" background-color: #f2f2f2; ">
    ...
    <center>
        <div class="card" style="text-align: center; color: #ffffff; background-color: #ab4840; border-radius: 30px;  width:34%;">
            <h1> Melihat Nilai Latihan User </h1>
        </div>
        </br>
    </center></br></br>
    ...
    $latihan_data = get_latihan_data();
    if ($latihan_data) {
        echo '<table>';
        echo '<tr><th>Nama Pengguna</th><th>Skor</th><th>Tanggal Penyelesaian</th></tr>';

        foreach ($latihan_data as $latihan) {
            echo '<tr>';
            echo '<td>' . $latihan['username'] . '</td>';
            echo '<td>' . $latihan['skor'] . '</td>';
            echo '<td>' . $latihan['waktu'] . '</td>'; // Tambahkan baris ini untuk menampilkan waktu
            echo '</tr>';
        }
