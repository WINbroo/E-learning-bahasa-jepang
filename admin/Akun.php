...
// Cek apakah form edit dikirimkan
if (isset($_POST['edit'])) {
}

// Cek apakah form hapus dikirimkan
...
<body style=" background-color: #f2f2f2; ">
    ...
    <center>
        <div class="card" style="text-align: center; color: #ffffff; background-color: #ab4840; border-radius: 30px;  width:30%;">
            <h1> Mengelola Akun User </h1>
        </div>
        </br>
    </center></br></br>
    ...
    if ($users) {
        echo '<table>';
        echo '<tr><th>Username</th><th>Email</th><th>Aksi</th></tr>';
        ...
        foreach ($users as $user) {
            ...
            echo '<td>';
            echo '<form method="post" action="Akun.php">';
